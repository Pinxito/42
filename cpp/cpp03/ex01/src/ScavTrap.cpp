...
/*   Updated: 2026/08/14 23:21:25 by gguillen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "ScavTrap constructor with parameters is called" << std::endl;
	this->_name = name;
	this->_hitPoints = 100;
	this->_energyPoints = 50;
	this->_attackDamage = 20;
...
void ScavTrap::attack(std::string const &target)
{
	...
	{
		std::cout << "ScavTrap " << this->_name << " has no energy left and cannot attack " << target << std::endl;
	}
}