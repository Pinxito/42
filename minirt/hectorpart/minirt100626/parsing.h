...
int		parse_line(t_scene *scene, t_parse_flags *flags, char **fields,
			int nfields);
int		parse_ambient(t_scene *scene, t_parse_flags *flags,
			char **fields, int nfields);
int		parse_camera(t_scene *scene, t_parse_flags *flags,
			char **fields, int nfields);
int		parse_light(t_scene *scene, t_parse_flags *flags,
			char **fields, int nfields);
